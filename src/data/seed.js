export const seedRooms = [
  { id: "courtyard", name: "Courtyard", facility: "Gardens", tier: 1, status: "Operational", visibility: "Public", skill: "Nature", capacity: 20, upkeep: 10, upgradeCost: 50, upgradeWeeks: 1, floorId: "ground", spaceType: "Common area", x: 155, y: 45, w: 275, h: 230, color: "#e9eadf" },
  { id: "hall", name: "Great Hall", facility: "Social Club", tier: 1, status: "Operational", visibility: "Public", skill: "Deception", capacity: 24, upkeep: 20, upgradeCost: 50, upgradeWeeks: 1, floorId: "ground", spaceType: "Common area", x: 475, y: 45, w: 300, h: 230, color: "#ece7de" },
  { id: "workshop", name: "Workshop", facility: "Workshop", tier: 1, status: "Operational", visibility: "Members", skill: "Crafting", capacity: 6, upkeep: 20, upgradeCost: 50, upgradeWeeks: 1, floorId: "ground", spaceType: "Operating space", x: 125, y: 320, w: 305, h: 225, color: "#e7e2d9" },
...
export const seedLayoutObjects = [
  { id: "hallway-north", name: "North hall", kind: "hallway", floorId: "ground", shape: "rect", x: 430, y: 135, w: 45, h: 50, color: "#e7e3da" },
  { id: "hallway-west-mid", name: "West hall", kind: "hallway", floorId: "ground", shape: "rect", x: 255, y: 275, w: 50, h: 45, color: "#e7e3da" },
  { id: "hallway-east-mid", name: "East hall", kind: "hallway", floorId: "ground", shape: "rect", x: 600, y: 275, w: 50, h: 45, color: "#e7e3da" },
  { id: "hallway-center", name: "Center hall", kind: "hallway", floorId: "ground", shape: "rect", x: 430, y: 405, w: 45, h: 50, color: "#e7e3da" },
  { id: "hallway-west-south", name: "Southwest hall", kind: "hallway", floorId: "ground", shape: "rect", x: 255, y: 545, w: 50, h: 45, color: "#e7e3da" },
  { id: "hallway-east-south", name: "Southeast hall", kind: "hallway", floorId: "ground", shape: "rect", x: 600, y: 545, w: 50, h: 45, color: "#e7e3da" },
  { id: "hallway-south", name: "South hall", kind: "hallway", floorId: "ground", shape: "rect", x: 430, y: 660, w: 85, h: 45, color: "#e7e3da" },
];
